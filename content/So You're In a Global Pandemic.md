...
1. Provide a level of interactive features that is roughly equivalent to Lightspeed Pascal circa 1986 (syntax highlighting, interactive debugger, easy code navigation especially to compiler errors).
